...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="components-accordion.html">
              <i class="bi bi-circle"></i><span>Laporan Absesnsi</span>
            </a>
          </li>
        </ul>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Tugas</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="tables-data.html">
              <i class="bi bi-circle"></i><span>Laporan Tugas</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      Designed by <a href="#">PurnamaSinarGemilang</a>
    </div>
  </footer><!-- End Footer -->
