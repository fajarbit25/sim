                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-end">
                            ...
                            @endif
                            @if($hide == 1)
                                <button type="button" class="btn btn-primary btn-sm m-3" wire:click="unhideData()"><span class="spinner-border spinner-border-sm" aria-hidden="true" wire:loading></span> Tampilan</button>
                            @endif
                        </div>
                        <div class="col-sm-12">
