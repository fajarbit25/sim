<div class="col-sm-12 row">
    ...
    <!-- Modal Create -->
    <div class="modal fade" id="modalEditAnak" wire:ignore.self 
    tabindex="-1" aria-labelledby="modalEditAnakLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form wire:submit.prevent="updateAnak">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalEditAnakLabel">Edit Data Anak</h1>
