<div class="col-sm-12">
    ...
    <div class="modal fade" wire:ignore.self id="modalDeleteAnak" tabindex="-1" aria-labelledby="modalDeleteAnakLabel" aria-hidden="true">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            Livewire.on('deleteAnak', function (id) {
                $("#modalDeleteAnak").modal('show')
            });

            Livewire.on('closeModal', function () {
                $('#modalDeleteAnak').modal('hide')
            });
        });
    </script>
