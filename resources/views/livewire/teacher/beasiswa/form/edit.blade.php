<div class="col-sm-12 row">
    ...
    <!-- Modal Create -->
    <div class="modal fade" id="modalEditBeasiswa" wire:ignore.self 
    tabindex="-1" aria-labelledby="modalEditBeasiswaLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form wire:submit.prevent="updateBeasiswa">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalEditBeasiswaLabel">Edit Data Beasiswa</h1>
    ...
    @push('scripts')
        <script>
            document.addEventListener('livewire:load', function () {
                ...
                Livewire.on('editBeasiswa', function () {
                    $('#modalEditBeasiswa').modal('show')
                }); //Membuka modal Edit

                Livewire.on('closeModal', function () {
                    $('#modalEditBeasiswa').modal('hide')
                }); //Menutup modal Edit
            });
        </script>
    @endpush
