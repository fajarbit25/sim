<div class="col-sm-12">
    ...
    <div class="modal fade" wire:ignore.self id="modalDeleteDiklat" tabindex="-1" aria-labelledby="modalDeleteDiklatLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalDeleteDiklatLabel">Confirm!</h1>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            Livewire.on('deleteDiklat', function (id) {
                $("#modalDeleteDiklat").modal('show')
            });

            Livewire.on('closeModal', function () {
                $('#modalDeleteDiklat').modal('hide')
            });
        });
    </script>
