<div class="col-sm-12 row">
    ...
    <div class="col-sm-12 my-4">
        <h5 class="text-success">Diklat</h5>
    ...
    <!-- Modal Create -->
    <div class="modal fade" id="modalCreateDiklat" wire:ignore.self 
    tabindex="-1" aria-labelledby="modalCreateDiklatLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form wire:submit.prevent="storeDiklat">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalCreateDiklatLabel">Tambah Data Diklat</h1>
    ...
    @push('scripts')
        <script>
            document.addEventListener('livewire:load', function () {
                ...
                Livewire.on('createDiklat', function () {
                    $('#modalCreateDiklat').modal('show')
                }); //Membuka modal create

                Livewire.on('closeModal', function () {
                    $('#modalCreateDiklat').modal('hide')
