<div class="col-sm-12">
    ...
    <div class="modal fade" wire:ignore.self id="modalDeleteBuku" tabindex="-1" aria-labelledby="modalDeleteBukuLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalDeleteBukuLabel">Confirm!</h1>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            Livewire.on('deleteBuku', function (id) {
                $("#modalDeleteBuku").modal('show')
            });

            Livewire.on('closeModal', function () {
                $('#modalDeleteBuku').modal('hide')
            });
        });
    </script>
