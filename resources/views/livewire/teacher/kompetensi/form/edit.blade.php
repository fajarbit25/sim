<div class="col-sm-12 row">
    ...
    <!-- Modal Create -->
    <div class="modal fade" id="modalEditKompetensiTeacher" wire:ignore.self 
    tabindex="-1" aria-labelledby="modalEditKompetensiTeacherLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form wire:submit.prevent="updateKompetensiTeacher">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalEditKompetensiTeacherLabel">Edit Data Kompetensi</h1>
    ...
    @push('scripts')
        <script>
            document.addEventListener('livewire:load', function () {
                ...
                Livewire.on('editKompetensi', function () {
                    $('#modalEditKompetensiTeacher').modal('show')
                }); //Membuka modal create

                Livewire.on('closeModal', function () {
                    $('#modalEditKompetensiTeacher').modal('hide')
