<div class="col-sm-12">
    ...
    <div class="modal fade" wire:ignore.self id="modalDeletePendidikan" tabindex="-1" aria-labelledby="modalCreateSertifikasiLabel" aria-hidden="true">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            Livewire.on('deletePendidikan', function (id) {
                $("#modalDeletePendidikan").modal('show')
            });

            Livewire.on('closeModal', function () {
                $('#modalDeletePendidikan').modal('hide')
            });
        });
    </script>
