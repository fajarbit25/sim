<div class="col-sm-12 row">
    ...
    <!-- Modal Create -->
    <div class="modal fade" id="modalEditPendidikanTeacher" wire:ignore.self 
    tabindex="-1" aria-labelledby="modalEditPendidikanTeacherLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form wire:submit.prevent="updatePendidikanTeacher">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalEditPendidikanTeacherLabel">Edit Data Pendidikan</h1>
    ...
    @push('scripts')
        <script>
            document.addEventListener('livewire:load', function () {
                ...
                Livewire.on('editPendidikan', function () {
                    $('#modalEditPendidikanTeacher').modal('show')
                }); //Membuka modal create

                Livewire.on('closeModalEdit', function () {
                    $('#modalEditPendidikanTeacher').modal('hide')
