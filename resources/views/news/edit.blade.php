        ...
        <div class="card">
          <div class="card-body">
            ...
            <form method="" action="" enctype="multipart/form-data" id="photoForm">
                @csrf
                <input type="hidden" name="idnews" id="idnews" value="{{$news->idnews}}" required/>
            <div class="mb-3">
    ...
    function loadValue()
    {
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                document.querySelector('#berita').value = response.berita;
