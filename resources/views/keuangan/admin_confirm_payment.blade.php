                    ...
                    <table class="table datatable" style="font-size: 13px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <span class="fw-bold text-success">{{'#'.$con->nomor_invoice}}</span> </td>
                                <td> {{$con->name}} </td>
                                <td> {{$con->account_id}} </td>
                                <td> {{$con->bank_name}} </td>
                                <td> <span class="fw-bold">{{'Rp.'.number_format($con->amount)}}</span> </td>
                                <td> 
                                    <a href="/finance/{{$con->kode_transaksi}}/verify" class="badge text-success"> Check <i class="bi bi-arrow-right-circle"></i></a>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
