...
<main id="main" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
                ...
                <div class="my-4">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <button type="submit" class="btn btn-success" id="btn-login">Login <i class="bi bi-box-arrow-in-right"></i></button>
                        </div>
                    </div>
                </div>
              </form>
            ...
            <div class="portfolio-info register">
                ...
                <form action="/smkit/ppdb" method="POST" id="formData">
                  @csrf
                  ...
                  <div class="my-4">
                      <div class="row">
                          ...
                          <div class="col-6 text-end">
                              <input type="hidden" name="campus_id" id="campus_id" value="4" required/>
                              <button type="submit" class="btn btn-success" id="btn-submit">Daftar <i class="bi bi-person-fill-add"></i></button>
                          </div>
                      </div>
                  </div>
                </form>
  ...
  <script type="text/javascript">
    ...
    $("#formLogin").submit(function(){
      ...
      $("#btn-login").html('<span class="spinner-border spinner-border-sm" aria-hidden="true"></span> Loading...')
    });
  </script>
  @endsection