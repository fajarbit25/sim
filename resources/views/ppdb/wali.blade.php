    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"> 7. Informasi Wali Peserta Didik</h5>
                ...
                <form action="{{url('/ppdb/wali')}}" method="POST" id="formData">
                    ...
                    <div class="col-lg-12 my-3 row">
                        ...
                        <div class="col-sm-10">
                          ...
                          <div class="form-text text-success fw-bold">
                            Nama ayah kandung peserta didik sesuai dokumen resmi yang berlaku. Hindari penggunaan gelar akademik atau sosial
                  ...
                  <div class="col-lg-12 my-3 row" id="keb-khususWali">    
                    ...
                    <div class="col-lg-12 mt-3 text-end">
                        <input type="hidden" name="segment" id="segment" value="wali" required/>
