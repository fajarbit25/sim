    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Data Peserta Lulus Verifikasi</h5>
                    ...
                    <table class="table datatable" style="font-size: 14px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/admin/{{$p->id}}/ppdb_review" class="badge text-success"> MANAGE <i class="bi bi-arrow-right-circle"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
